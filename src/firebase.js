...
// import { getDatabase } from "firebase/database";   // Uncomment for Realtime DB
...
// const db = getFirestore(app); // Uncomment when you add Firestore

export { auth, googleProvider };
// export { db }; // Uncomment when you add Firestore
export default app;